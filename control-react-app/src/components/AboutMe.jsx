...
const AboutMe = () => {
  ...
  <div className="about-me-slide">
    <div className="slide-content">
      ...
      <div className="carousel-item side-item">
        <p className="about-me-p">I love playing video games, do photography and exploring wild places far from civilization. If you are interested to learn more about me or my app you can connect with me on <a href="https://www.linkedin.com/in/aleks310/">LinkedIn</a>.</p>
      </div>
    </div>
  </div>
